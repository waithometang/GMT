  ...
  <div class="report">
    <div class="select">
      <div
        ...
        :class="{'border1': tagState === item.state}"
    ...
    <div class="want-report">
      <!-- <van-button
        ...
        to="/mlgm/jbhjhd/wantToReport"
      >
        <span><img src="../images/举报.png">我要随手拍</span>
      </van-button> -->
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    SetGrxx () {
      ...
      let content = Grxx.smrzzt === '认证中' ? '实名认证中,请等待': '请先实名认证'
  ...
  created() {
    if(this.$route.params.id){
      this.tagState = this.$route.params.id
    }    
