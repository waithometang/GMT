<!-- 诉求反映 -->
<template>
  <div class="randomlySnapPicture" v-if="shoaPage">
    <div class="select">
      <div
...
import needPhono from "@/components/secondLevelPages/ruralRevitalization/needPhono"
  ...
  methods: {
    changeState(item) {
      ...
      if (this.$route.name === "livelihood") {
        ...
        document.title = "区长直通车"
        // switch (item) {
        //   case 1:
        //     document.title = "大家的反映"
        //     break
        //   case 2:
        //     document.title = "我的反映"
        //     break
