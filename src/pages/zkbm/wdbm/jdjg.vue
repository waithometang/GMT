          ...
          <template v-if="thisData.kscj">
            <div class="item" v-if="thisData.kscj.zcj_1">
              ...
              <div class="message">
                ...
                <p v-if="thisData.kscj.pm_1!='无'"> 名&emsp;&emsp;次：{{thisData.kscj.pm_1}}</p>
            ...
            <div class="item" v-if="thisData.kscj.zcj_2">
              ...
              <div class="message">
                ...
                <p v-if="thisData.kscj.pm_2!='无'"> 名&emsp;&emsp;次：{{thisData.kscj.pm_2}}</p>
...
export default {
  data(){
    return{
      show:false,
      listData: [{name: '基本信息', state: 1}, {name: '证明材料', state: 2}, {name: '进度结果', state: 3}],      tabState:3,
      stepIndex:0,
      thisData:{
        xm:'',
      }
